...
The development tools used in this project were selected based on their ability to meet the requirements of the project. The tools were selected to ensure 
that the project was developed in a timely manner and that the stakeholders were satisfied with the progress. The tools used in the project are as follows:
...
Visual Studio Code was used as the primary code editor for the project, it was also used for this own dissertation as it also supports latex. Visual Studio Code is a popular code editor that is widely used in the software development
