...
\subsubsection*{Fine Motor Tracking Time}
...
\begin{itemize}
    \item General Trend: The predictions generally track the trend of the actual Fine Motor Accuracy values; however, there are some deviations in the model's ability 
